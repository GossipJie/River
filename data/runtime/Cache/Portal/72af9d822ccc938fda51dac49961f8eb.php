        ...
        <div class="dh_about">
                ...
                <div class="dh_col_1_m">
                    ...
                    <a  href="<?php echo leuu('portal/page/index',array('id'=>$about_page_id,'pid'=>$about_page_pid ));?>">
           			...
           			<a  href="<?php echo leuu('portal/page/index',array('id'=>$about_page_id,'pid'=>$about_page_pid ));?>"><?php echo msubstr($pagex['post_excerpt'],0,120);?></a>
                </div>
        </div>
        <div class="dh_news">
    ...
    <div class="dh_col_2">
        <div class="dh_new2">
                <div class="dh_col_2_tit">
                    ...
                    <a href="<?php echo leuu('list/index',array('id'=>$p2['term_id'],'pid'=>$about_news_pid));?>">更多 &gt;</a>
                </div>
        ...
        <div class="dh_new3">
                <div class="dh_col_2_tit">
                    ...
                    <a href="<?php echo leuu('list/index',array('id'=>$p3['term_id']));?>">更多 &gt;</a>
                </div>
             ...
             <ul>
                ...
                <li>
                    ...
                    <span><a href="<?php echo leuu('article/index',array('id'=>$vo['tid']));?>" title="<?php echo ($vo["post_keywords"]); ?>"><?php echo ($vo["post_keywords"]); ?></a></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
