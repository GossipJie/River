...
<title><?php echo ($post_title); ?>-<?php echo ($site_seo_title); ?></title>
...
<div class="inner">
    <div class="dh_col_3 pape_left">
        ...
        <div class="dh_right_bg">
        	<?php $pid=$_GET['pid']; $nav_p = $navs[$pid]; $nav_p_1ist= $nav_p['child']; ?>
            <div class="dh_right_t">
                <a href="<?php echo ($nav_p["href"]); ?>&pid=<?php echo ($pid); ?>" title="<?php echo ($nav_p["label"]); ?>"><?php echo ($nav_p["label"]); ?></a>
            </div>
            <ul>
			<?php if(is_array($nav_p_1ist)): $i = 0; $__LIST__ = $nav_p_1ist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li ><a href="<?php echo ($v["href"]); ?>&pid=<?php echo ($nav_p["id"]); ?>&oid=<?php echo ($v["id"]); ?>" title="<?php echo ($v["label"]); ?>"><?php echo ($v["label"]); ?></a><i class="fa fa-chevron-right"></i></li><?php endforeach; endif; else: echo "" ;endif; ?> 
            </ul>
            <div class="clear"></div>
        </div>    
...
<?php if(is_array($nav_ojs_1ist)): $i = 0; $__LIST__ = $nav_ojs_1ist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a class="dh_sev1" href="<?php echo ($v["href"]); ?>&pid=<?php echo ($nav_ojsx["id"]); ?>&oid=<?php echo ($v["id"]); ?>" title="<?php echo ($v["label"]); ?>">
    ...
    <div class="dh_col_4">
        <div class="pape_title">
        	<?php $oid= $_GET['oid']; $present=sp_get_term($term_id); ?>
              <span><?php echo ($present["name"]); ?></span>
                       <ol class="breadcrumb" >
                        <li><a href="/">首页</a></li>
                        <li><a href="<?php echo ($nav_p["href"]); ?>&pid=<?php echo ($pid); ?>"><?php echo ($nav_p["label"]); ?></a></li>
                        <li><a href="<?php echo leuu('portal/list/index',array('id'=>$term_id,'pid'=>$pid,'oid'=>$oid));?>"><?php echo ($present["name"]); ?></a></li>
                ...
                <div class="post-title">
					...
					<div class="post_icon"> 
						<!-- <span class="postcat"><i class="fa fa-list-ul"></i> <a href="#">下载</a></span> -->
						<span class="postclock"><i class="fa fa-clock-o"></i><?php echo ($post_date); ?></span>
						<span class="posteye"><i class="fa fa-eye"></i> <?php echo ($post_hits); ?></span>
					</div>
				</div>
					
                <div class="pape_about">
