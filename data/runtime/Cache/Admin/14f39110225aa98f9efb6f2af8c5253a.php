	...
	<div class="wrap">
		...
		<div class="home_info">
			<ul id="thinkcmf_notices">
				<li><img src="/admin/themes/simplebootx/Public/assets/images/loading.gif"style="vertical-align: middle;" /><span style="display: inline-block; vertical-align: middle;">鍔犺浇涓�...</span></li>
			</ul>
		</div> -->
		<h4 class="well"><?php echo L('SYSTEM_INFORMATIONS');?></h4>
		<div class="home_info">
			<ul>
				<?php if(is_array($server_info)): $i = 0; $__LIST__ = $server_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($key=="程序版本")continue; ?>
					<li><em><?php echo ($key); ?></em> <span><?php echo ($vo); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
		...
		<div class="home_info" id="home_devteam">
			<ul>
				...
				<li><em><?php echo L('TEAM_MEMBERS');?></em> <span>Dean,Sam,Tuolaji,Smile,Codefans,鐫′笉閱掔殑鐚�,Jack,鏃ユ湰閭ｅ彧鐚�</span></li>
		...
		<div class="">
			<ul class="inline" style="margin-left: 25px;">
				...
				<li><a>棣欓鍜歌泲榛�</a></li>
				<li><a>灏忓</a></li>
				<li><a href="http://www.xdmeng.com" target="_blank">灏忓嚡</a></li>
