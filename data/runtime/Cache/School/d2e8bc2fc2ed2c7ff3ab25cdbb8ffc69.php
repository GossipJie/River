			...
			<table class="table table-hover table-bordered table-list" ng-controller="showCtrl">
				<thead>
					<tr>
						...
						<th width="50">省份</th>
						 <th width="50">获奖等级</th>
						 <th width="50">获奖成果名称</th>
						 <th width="50">完成人</th>
						 <th width="50">获奖年度</th>
						 <th width="50">证书编号</th>
						 <th width="50">参与单位数</th>
						 <th width="50">本单位参与学科书</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr ng-repeat="vo in fv">
						...
						<td ng-bind="vo.HJLB"></td>
						<td ng-bind="vo.SF"></td>
						<td ng-bind="vo.HJDJ"></td>
						<td ng-bind="vo.CGMC"></td>
						<td ng-bind="vo.WCR"></td>
						<td ng-bind="vo.HJND"></td>
						<td ng-bind="vo.ZSBH"></td>
						<td ng-bind="vo.CYDWS"></td>
						<td ng-bind="vo.BDWCYXKS"></td>
					</tr>
