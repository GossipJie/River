			...
			<table class="table table-hover table-bordered table-list" ng-controller="showCtrl">
				...
				<tbody>
					...
					<tr ng-repeat="vo in fv">
						...
						<td ng-bind="vo.ZZMC"></td>
						<td ng-bind="vo.ZZ"></td>
						<td ng-bind="vo.CBS"></td>
						<td ng-bind="vo.CBNY"></td>
						<td ng-bind="vo.ISBN"></td>
						<td ng-bind="vo.YS"></td>
						<td ng-bind="vo.YBCBS"></td>
						<td ng-bind="vo.YBCBNY"></td>
						<td ng-bind="vo.CYXKS"></td>
